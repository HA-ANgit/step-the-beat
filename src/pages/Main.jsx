...
import '/Users/hannespro/Documents/Pro/step-the-beat/src/App.css';
      ...
      <div className='container'>
        ...
        <main className='container'>
          <h1 className="App-title">I am Drum Machine [┐∵]┘</h1>
            <p>
              En tempo-baserad trummaskin som är {this.handleReset.resetClicked ? 'Startad' : 'Avstängd'} {/* If-loop som kikar på state och är dynamisk */}
            </p>
              <DrumMachine/>
